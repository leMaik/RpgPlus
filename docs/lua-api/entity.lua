...
-- * `"entity.attack.entity"` - Called when the entity damaged another entity, note that this entity is the damager and the attacked entity is the entity of the event [EntityDamageByEntityEvent](https://hub.spigotmc.org/javadocs/bukkit/index.html?org/bukkit/event/entity/EntityDamageByEntityEvent.html)
...
-- * `"entity.damage.byEntity"` - Called when the entity was damaged by another entity [EntityDamageByEntityEvent](https://hub.spigotmc.org/javadocs/bukkit/index.html?org/bukkit/event/entity/EntityDamageByEntityEvent.html)
